...
namespace OOK.API.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        public async Task<IActionResult> SetMainPhoto(int userId, int id)
        {
            ...
            // ensure the photo passed in exists in the user colllection
        ...
        public async Task<IActionResult> DeletePhoto(int userId, int id)
        {
            ...
            if (photoFromRepo.PublicId != null) // is a cloudinary image
            {

                // need to delete from cloudinary and the database
            ...
            // But if it's in our local non-cloudinary repo:
